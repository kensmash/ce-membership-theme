...
<?php if (is_active_sidebar('top-nav-search')) : ?>
  <button class="btn btn-outline-light ms-1 ms-md-2 top-nav-search-md" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-search" aria-expanded="false" aria-controls="collapse-search">
...
if ( is_cart() ) {
 // Do nothing
  ...
  <a class="btn btn-outline-light ms-1 ms-md-2" href="<?= wc_get_cart_url() ?>">
