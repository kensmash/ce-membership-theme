...
$background_image  = 'url(' . get_field( 'background_image' ) . '); background-attachment: fixed; background-position: top left; background-repeat: no-repeat; background-size: auto 50%;';
