...
if ( ! function_exists( 'comics_experience_post_classes' ) ) {
	 ...
	 */
	function comics_experience_post_classes( $classes, $class, $post_id ) {
...
add_filter( 'post_class', 'comics_experience_post_classes', 10, 3 );
